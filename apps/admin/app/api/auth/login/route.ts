...
export async function POST(req: NextRequest) {
  ...
  // Este painel é exclusivo de ADMIN — nunca emitir cookie de sessão pra
  // outro tipo de conta, mesmo que a senha esteja correta.
  if (user.tipo !== "ADMIN") {
    return NextResponse.json(
  ...
  // Fluxo de desafio MFA ainda não tem tela nesta interface.
