 ...
 * automaticamente ainda (nenhum retry-on-401 nem refresh silencioso
 * agendado) — ver PENDENCIAS.md. Por enquanto, a sessão expira em
 * JWT_ACCESS_TTL_SECONDS (15min por padrão) e exige novo login.
 */
